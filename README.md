...
[![npm](https://img.shields.io/npm/v/flax-api.svg?style=flat-square)](https://www.npmjs.com/package/flax-api)
...
const { Connection, constants, ApiClient } = require('flax-api');
